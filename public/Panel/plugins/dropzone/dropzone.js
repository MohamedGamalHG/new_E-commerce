  ...
  dropzone_createClass(Dropzone, [{
    ...
    value: function addFile(file) {
      ...
      file.upload = {
        ...
        progress: 0,
        // SettingController the total upload size to file.size for the beginning
    ...
    value: function _uploadData(files, dataBlocks) {
      ...
      xhr.open(method, url, true); // SettingController the timeout after open because of IE11 issue: https://gitlab.com/meno/dropzone/issues/8
